...
teb_cpp.launch.py
====================
Full simulation stack with C++ TEB local planner driving /cmd_vel directly.

Adds:
  - local_costmap_node   (Li পণ্ডিত -> occupancy grid)
...
def generate_launch_description():
    ...
    # REPLACED path_planning_node WITH C++ NODE
    teb_cpp_node = Node(
        package='teb_cpp_pkg', executable='cpp_node',
        name='teb_cpp_node', output='screen',
        parameters=[{'use_sim_time': True}],
    )
